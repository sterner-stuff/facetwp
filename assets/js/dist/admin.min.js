        ...
        function init_vue() {
            ...
            Vue.component('facet-edit', {
                ...
                methods: {
                    ...
                    checkEmpty: function checkEmpty(e) {
                ...
                methods: {
                    ...
                    maybeEdit: function maybeEdit(row) {
                        if (this.$root.is_name_editable ) {
                            var new_name = this.sanitizeName(row.label, row.name);
                    ...
                    sanitizeName: function sanitizeName(name, original_name) {
                    ...
                    preventDuplicateName: function preventDuplicateName(name, original_name) {
                        ...
                        var other_names = names.filter(function(existing_name) {
                        ...
                        var base_name = name.replace(/_(\d+)$/, '');
            ...
            FWP.vue = new Vue({
                ...
                methods: {
                    ...
                    duplicateItem: function duplicateItem(type, index) {
                        var item = this.cloneObj(this.app[type + 's'][index]);
                        item.label += ' (copy)';
                    ...
                    deleteItem: function deleteItem(type, index) {
                        var item = this.app[type + 's'][index];
                        var prompt = FWP.__('Delete the "') + item.label + '" (' + item.name + ') ' + ( 'template' == type ? FWP.__('listing?') : FWP.__('facet?') );
                        if (confirm(prompt)) {
                    ...
                    maybeEditName: function maybeEditName(item) {
                        if (this.is_name_editable ) {
                            var new_name = this.sanitizeName(item.label);
                            if ( new_name.length > 0 ) {
                                item.name = new_name;
                            } else {
